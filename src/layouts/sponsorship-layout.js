...
import SponsorshipListPage from '../pages/sponsors/sponsorship-list-page'
import EditSponsorshipPage from '../pages/sponsors/edit-sponsorship-page'
...
class SponsorshipLayout extends React.Component {
    ...
    render(){
        ...
        return(
            <div>
                <Breadcrumb data={{ title: T.translate("sponsorship_list.sponsorships"), pathname: match.url }} ></Breadcrumb>
